...
class Application {
    ...
    public  $COINS_MARKET_DATA_URL = 'https://min-api.cryptocompare.com/data/pricemultifull?fsyms=%s&tsyms=%s';
    public  $CURRENCIES_MARKET_DATA_URL = 'https://openexchangerates.org/api/latest.json?app_id=%s&base=%s';
    public $COINS_LIST_URL = 'https://min-api.cryptocompare.com/data/all/coinlist';
    public $COIN_DETAIL_URL = 'https://www.cryptocompare.com/api/data/coinsnapshotfullbyid/?id=%s';
    ...
    private function loadModels() {
        ...
        include path('includes/models/crypto.php');
        include path('includes/models/post.php');
        include path('includes/models/blog.php');
        include path('includes/models/portfolio.php');
        load_admin_settings();
    }
...
class Layout {
    ...
    public function __construct() {
        ...
        $this->favicon = url(config('site-favicon', 'assets/images/favicon.png'));
    }
    ...
    public function setTitle($title = "") {
        $titleStr = config('site-title', 'TCrypto');
